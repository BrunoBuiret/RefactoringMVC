...
public class TriangularTurtle extends PolygonalTurtle
{
     ...
     */
    public TriangularTurtle(double x, double y, Color color, double sightRadius, double sightAngle, double edgeSize)
    {
        super(x, y, color, sightRadius, sightAngle, 3, Math.sqrt(Math.pow(edgeSize, 2) - Math.pow(edgeSize / 2, 2)) / 2);
    }
}
